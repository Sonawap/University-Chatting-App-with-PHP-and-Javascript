                            ...
                            <?php while($row = $result->fetch_assoc()) : ?>
                                <div class="media status-head">
                                    <div class="media-left">
                                        <a  href="view_profile.php?user_id=<?php echo $row['id'] ?>&key=<?php echo md5($row['firstname']) ?>"><img class="img-circle status-image" src="images/profile_pic/<?php echo $row['profile_pic'] ?>" width="70" height="70"></a>
                                    </div>
                                    <div class="media-body">
                                        <div class="follow-head">
                                            <div class="col-sm-12">
                                                <a  href="view_profile.php?user_id=<?php echo $row['id'] ?>&key=<?php echo md5($row['firstname']) ?>"><h4><?php echo $row['firstname'].' ' . $row['othername'] ?></h4></a>
